...
*Nota Operacional para IAs:* A pipeline CI na Vercel nega merge requests onde a pasta `apps/api` sofra commits sem seu arquivo `.test.ts` passar nos scripts (`npm run test --workspace=api`).
