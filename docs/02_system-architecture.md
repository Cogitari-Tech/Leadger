...
export const dashboardModuleConfig = {
  id: "dashboard", routes: [ {path: "roadmap", element: <RoadmapComponent /> } ]
};
// Magica Acontece!
```

---
*Fim da Documentação Base Sistêmica.*
